...
public class Tag04 {
    ...
    public static void part1(){
        ...
        for (int row = 0; row < 5; row++) {
            for (int col = 0; col < 5; col++) {
                if (cards[winningCard][col][row] > 0){
                    result += cards[winningCard][col][row];
                }
            }
        }
        result *= numCalled;
    ...
    public static void part2() {
        boolean[] cardHasWon = new boolean[100];
        ...
        for (int row = 0; row < 5; row++) {
            for (int col = 0; col < 5; col++) {
                ...
                result += cards[losingCard][row][col];
                }
            }
        }
        result *= numCalled;
